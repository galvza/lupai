...
- **Global scope**: `C:/Users/biela/OneDrive/Documentos/github/lupai/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/biela/OneDrive/Documentos/github/lupai/.claude/notes/`)
...
2. Glob `C:/Users/biela/OneDrive/Documentos/github/lupai/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/biela/OneDrive/Documentos/github/lupai/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/biela/OneDrive/Documentos/github/lupai/.claude/notes/` — works in any directory
